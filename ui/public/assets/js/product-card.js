...
const card = (product) => `
            <div onclick="addToCart('${product.name}', '${product.image}', '${product.price}')" class="custom-col-5">
                ...
                <div class="product-img">
                    ...
                    <div class="product-action">
                        <div class="pro-action-left">
                            <a onclick="addToCart('${product}')" title="Add To Cart"><i class="ion-android-cart"></i> Add To Cart</a>
                        </div>
